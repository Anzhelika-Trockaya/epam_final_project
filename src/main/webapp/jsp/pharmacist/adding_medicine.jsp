...
<div class="medicine_form">
    <form name="medicine_form" id="medicine_form" action="${context_path}/controller" method="post"
        ...
        <input type="text" class="uppercase" id="name" name="medicine_name" value="${medicine_name}"/>
        ...
        <input type="checkbox" id="need_prescription" name="medicine_need_prescription"
        ...
        <select id="manufacturer" name="medicine_manufacturer_id" size="1">
        ...
        <input type="text" id="number_in_package" name="medicine_number_in_package" value="${medicine_number_in_package}"/>
        ...
        <c:choose>
            <c:when test="${empty medicine_id}">
                ...
                <input type="text" id="total_packages" name="medicine_total_packages" value="${medicine_total_packages}"/>
        ...
        <input type="text" id="price" name="medicine_price" value="${medicine_price}"/>
        ...
        <input type="file" style="display:none;" onchange="onChangeFile()" id="image" name="medicine_image_link"
...
<script>
    const fileInput = document.forms["medicine_form"]["medicine_image_link"];
    ...
    function validate() {
        ...
        const nameInput = document.forms["medicine_form"]["medicine_name"];
        const internationalNameInput = document.forms["medicine_form"]["medicine_international_name_id"];
        const formInput = document.forms["medicine_form"]["medicine_form_id"];
        const dosageInput = document.forms["medicine_form"]["medicine_dosage"];
        const unitInput = document.forms["medicine_form"]["medicine_dosage_unit"];
        const manufacturerInput = document.forms["medicine_form"]["medicine_manufacturer_id"];
        const numberInPackageInput = document.forms["medicine_form"]["medicine_number_in_package"];
        const priceInput = document.forms["medicine_form"]["medicine_price"];
        let result = true;
        if (${empty medicine_id}) {
            const totalPackagesInput = document.forms["medicine_form"]["medicine_total_packages"];
